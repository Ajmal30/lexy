...
/// List are similar to arrays but list is a child of Iterable
/// Therefore Maps, List, LinkedList are all child of Iterable to be able to loop using the keyword `for`
